...
🚀 Funcionalidades
🎧 Entrada de áudio (.wav)
📝 Transcrição automática com Whisper
🤖 Envio do texto para o ChatGPT
💬 Retorno da resposta em texto
...
voice-chatgpt-whisper/ │ ├── src/ # Código-fonte do projeto │├── main.py # Script principal │ ├── venv/ # Ambiente virtual (ignorado no Git) ├── .env.example # Exemplo de variáveis de ambiente ├── .gitignore # Arquivos ignorados pelo Git ├── requirements.txt # Dependências do projeto └── README.md # Documentação
